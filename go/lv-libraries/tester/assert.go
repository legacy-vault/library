...
// MustBeAnError Method ensures that the Error is not nil. If the Error is
// nil, it stops the Test.
...
// MustBeNoError Method ensures that the Error is nil. If the Error is not
// nil, it stops the Test.
...
// MustBeEqual Method ensures that two Variables have equal Values. If not, it
// stops the Test.
...
// MustBeDifferent Method ensures that two Variables have different Values. If
// not, it stops the Test.
